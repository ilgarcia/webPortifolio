    ...
    <section id="experience" className="max-w-4xl min-h-[80vh] mx-auto pt-24 px-4 lg:px-0">
      ...
      <div className="lg:flex lg:max-w-4xl">
        <div className="flex mb-6 overflow-x-auto lg:block lg:mb-0 ">
          <button
            className={`"flex whitespace-nowrap max-w-[220px] w-full px-2 py-3 border-solid border-gray-600 border-b-2 lg:border-l-2 lg:border-b-0 ease-in-out transition-all duration-500 hover:bg-opacity-5 hover:bg-theme-orange " ${
              openTab === 1 &&
              "text-theme-orange border-theme-orange bg-theme-orange bg-opacity-5"
            }`}
            onClick={(e) => {
              e.preventDefault();
              setOpenTab(1);
